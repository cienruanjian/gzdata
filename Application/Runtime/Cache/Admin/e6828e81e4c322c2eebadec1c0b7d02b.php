                    	...
                    	<div class="col-lg-12">
	                    	...
	                    	<section class="panel">
		                        ...
		                        <div class="panel-body">
		                            <form class="form-horizontal bordered-group" role="form" action="<?php echo U('Type/editHandle');?>" method="post">
		                                <div class="form-group">
		                                    <label for="inputEmail3" class="col-sm-2 control-label">类别名称</label>
		                                    <div class="col-sm-6">
		                                        <input type="text" name="name" placeholder="类别名称" class="form-control" id="inputEmail3" value="<?php echo ($data["name"]); ?>">
		                                    </div>
		                                </div>
		                                <div class="form-group">
		                                    <label for="inputEmail3" class="col-sm-2 control-label">排序</label>
		                                    <div class="col-sm-6">
		                                        <input type="text" class="form-control" name="sort" id="inputEmail3" value="<?php echo ($data["sort"]); ?>" placeholder="排序">
		                                    </div>
		                                </div>
		                                ...
		                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="status" value="1" <?php if(($data['status']) == "1"): ?>checked<?php endif; ?>>开启</label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="status" value="0" <?php if(($data['status']) == "0"): ?>checked<?php endif; ?>>停用</label>
                                                </div>
                                            </div>
                                        </div>
		                                ...
		                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="desc" rows="2"><?php echo ($data["desc"]); ?></textarea>
                                            </div>
                                        </div>
