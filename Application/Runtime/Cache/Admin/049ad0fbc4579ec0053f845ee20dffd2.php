                        ...
                        <div class="col-xs-12">
                            <section class="panel">
                                <header class="panel-heading">
                                 <a href="<?php echo U('Question/add');?>" class="btn btn-xs btn-success">添加</a>
                                </header>
                                        ...
                                        <table id="table" class="table table-striped responsive" data-sortable="" data-sortable-initialized="true">
                                            ...
                                            <tbody>
                                            	<?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		                                                    ...
		                                                    <td>
		                                                    	<a href="<?php echo U('Question/edit', ['id' => $v['id'], 'pos' => $pos]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑"><span class="fa fa-edit text-success"></span></a>&nbsp;
	                                             			  	<a class="del" href="<?php echo U('Question/del', ['id' => $v['id']]);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="删除"><span class="fa fa-trash-o text-success"></span></a>
		                                                    </td>
