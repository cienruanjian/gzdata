    ...
    <div id="h302"></div>
      <div class="all" style="over-flow:hidden">
        <div class="all_1">
          ...
          <div class="all_1_r">
            <ul>
              <?php if(is_array($list)): foreach($list as $key=>$v): ?><li><a href="<?php echo U('Intro/index', ['id' => $v['id']]);?>"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>
            </ul>
          </div>
          <div class="clear"></div>
        </div>
        <div class="all_2">
          <div class="all_2_1">
            <div class="all_2_1_l"><?php echo ($article["title"]); ?></div>
            <div class="all_2_1_r">您现在的位置：首页>大赛简介</div>
            <div class="clear"></div>
          </div>
          <div class="all_2_3" style="min-height:500px;">
