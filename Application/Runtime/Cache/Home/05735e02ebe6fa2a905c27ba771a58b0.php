  ...
  <div id="khuj" style="background:url(/Public/Home/images/jj.jpg) center top no-repeat;">
    <div id="h302"></div>
      <div class="all" style="over-flow:hidden">
        ...
        <div class="all_2">
          <div class="all_2_1">
            <div class="all_2_1_l">大赛简介</div>
            <div class="all_2_1_r">您现在的位置：首页>大赛简介</div>
            <div class="clear"></div>
          </div>
          <div class="all_2_2">
            <img src="/Public/Home/images/qzy/7.jpg" width="813" height="49" />
          </div>
          <div class="all_2_3">
            <p>
              贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业产业贵州在大数据产业
            </p>
            <p>
              贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业产业贵州在大数据产业
            </p>
          ...
          <div class="all_2_2">
            <img src="/Public/Home/images/qzy/8.jpg" width="812" height="49" />
          </div>
          <div class="all_2_4">2015年10月-2016年6月</div>
          <div class="all_2_2">
            <img src="/Public/Home/images/qzy/8.jpg" width="812" height="49" />
          </div>
          <div class="all_2_5">
            <p>
              贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产据产业贵州在大大数据产业贵州在大数据产业贵州在大数据产业贵州产业贵州在大数大数据产业
            </p>
            <p>
              贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产业贵州在大数据产据产业贵州在大大数据产业贵州在大数据产业贵州在大数据产业贵州产业贵州在大数大数据产业
            </p>
