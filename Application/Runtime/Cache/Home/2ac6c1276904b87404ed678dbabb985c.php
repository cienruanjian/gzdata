  ...
  <div id="khuj" style="background:url(/Public/Home/images/zu.jpg) center top no-repeat;">
    ...
    <div class="all">
      ...
      <div class="all_2">
        ...
        <div class="all_2_2">
          <div class="all_2_2_l">
            <img src="/Public/Home/images/qzy/5.jpg" width="230" height="136" />
          </div>
          <div class="all_2_2_r">
            <div class="all_2_2_r_1">"云上贵州"大数据商业模式大赛落幕"东方祥云"项目摘取云端大奖</div>
            <div class="all_2_2_r_2">
              发布时间：
              <span>2015-04-24</span>
            </div>
            <div class="all_2_2_r_3">
              4月11日，2014中国"云上贵州"大数据商业模式大赛总决赛数据商业模式大赛总决赛数据商业模式大赛总决赛数据商业模式大赛总决赛数据商业模式大赛总决赛
            </div>
            <div class="all_2_2_r_4">
              <a href="<?php echo U('Article/detail', array('id' => 3));?>">查看更多&gt;&gt;</a>
            </div>
          </div>
          <div class="clear"></div>
        </div>
